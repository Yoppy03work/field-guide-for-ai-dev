  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col bg-[#FBFAF7] text-[#1F2937]">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[60] focus:rounded-md focus:bg-[#2F5D3A] focus:px-4 focus:py-2 focus:text-sm focus:font-semibold focus:text-white focus:outline-2 focus:outline-offset-2 focus:outline-[#FFF3C4]"
        >
          メインコンテンツへスキップ
        </a>
        <Header />
